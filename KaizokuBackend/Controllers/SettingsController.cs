...
namespace KaizokuBackend.Controllers
{
    ...
    public class SettingsController : ControllerBase
    {
        ...
        /// <param name="type">The template type (0 = FileName, 1 = FolderPath).</param>
        ...
        /// </summary>
        /// <param name="template">The template string to preview.</param>
        /// <param name="type">The template type (0 = FileName, 1 = FolderPath).</param>
        /// <returns>Preview string showing how the template would render.</returns>
        /// <response code="200">Returns the preview string</response>
